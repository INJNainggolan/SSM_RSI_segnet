...
def SegNet_pooling_indices():
    ...
    conv1_1 = Conv2D(64, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv1_1')(inputs)
    conv1_1_bn = BatchNormalization(name = 'conv1_1_bn')(conv1_1)
    conv1_2 = Conv2D(64, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv1_2')(conv1_1_bn)
    conv1_2_bn = BatchNormalization(name = 'conv1_2_bn')(conv1_2)
    pool1 = MaxPooling2D(pool_size=(2, 2), name = 'pool1')(conv1_2_bn)

    conv2_1 = Conv2D(128, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv2_1')(pool1)
    conv2_1_bn = BatchNormalization(name = 'conv2_1_bn')(conv2_1)
    conv2_2 = Conv2D(128, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv2_2')(conv2_1_bn)
    conv2_2_bn = BatchNormalization(name = 'conv2_2_bn')(conv2_2)
    pool2 = MaxPooling2D(pool_size=(2, 2), name = 'pool2')(conv2_2_bn)

    conv3_1 = Conv2D(256, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv3_1')(pool2)
    conv3_1_bn = BatchNormalization(name = 'conv3_1_bn')(conv3_1)
    conv3_2 = Conv2D(256, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv3_2')(conv3_1_bn)
    conv3_2_bn = BatchNormalization(name = 'conv3_2_bn')(conv3_2)
    conv3_3 = Conv2D(256, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv3_3')(conv3_2_bn)
    ...
    conv4_1 = Conv2D(512, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv4_1')(encdrop3)
    conv4_1_bn = BatchNormalization(name = 'conv4_1_bn')(conv4_1)
    conv4_2 = Conv2D(512, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv4_2')(conv4_1_bn)
    conv4_2_bn = BatchNormalization(name = 'conv4_2_bn')(conv4_2)
    conv4_3 = Conv2D(512, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv4_3')(conv4_2_bn)
    ...
    conv5_1 = Conv2D(512, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv5_1')(encdrop4)
    conv5_1_bn = BatchNormalization(name = 'conv5_1_bn')(conv5_1)
    conv5_2 = Conv2D(512, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv5_2')(conv5_1_bn)
    conv5_2_bn = BatchNormalization(name = 'conv5_2_bn')(conv5_2)
    conv5_3 = Conv2D(512, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv5_3')(conv5_2_bn)
    ...
    conv5_3_D = Conv2D(512, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv5_3_D')(up5)
    conv5_3_D_bn = BatchNormalization(name = 'conv5_3_D_bn')(conv5_3_D)
    conv5_2_D = Conv2D(512, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv5_2_D')(conv5_3_D_bn)
    conv5_2_D_bn = BatchNormalization(name = 'conv5_2_D_bn')(conv5_2_D)
    conv5_1_D = Conv2D(512, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv5_1_D')(conv5_2_D_bn)
    ...
    conv4_3_D = Conv2D(512, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv4_3_D')(up4)
    conv4_3_D_bn = BatchNormalization(name = 'conv4_3_D_bn')(conv4_3_D)
    conv4_2_D = Conv2D(512, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv4_2_D')(conv4_3_D_bn)
    conv4_2_D_bn = BatchNormalization(name = 'conv4_2_D_bn')(conv4_2_D)
    conv4_1_D = Conv2D(512, (3, 3), strides=(1,1), activation="relu", padding="same", name = 'conv4_1_D')(conv4_2_D_bn)
    ...
    conv3_3_D = Conv2D(256, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv3_3_D')(up3)
    conv3_3_D_bn = BatchNormalization(name = 'conv3_3_D_bn')(conv3_3_D)
    conv3_2_D = Conv2D(256, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv3_2_D')(conv3_3_D_bn)
    conv3_2_D_bn = BatchNormalization(name = 'conv3_2_D_bn')(conv3_2_D)
    conv3_1_D = Conv2D(256, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv3_1_D')(conv3_2_D_bn)
    ...
    conv2_2_D = Conv2D(128, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv2_2_D')(up2)
    conv2_2_D_bn = BatchNormalization(name = 'conv2_2_D_bn')(conv2_2_D)
    conv2_1_D = Conv2D(128, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv2_1_D')(conv2_2_D_bn)
    ...
    conv1_2_D = Conv2D(64, (3, 3), strides=(1,1), activation="elu", padding="same", name = 'conv1_2_D')(up1)
    conv1_2_D_bn = BatchNormalization(name = 'conv1_2_D_bn')(conv1_2_D)

    conv1_1_D = Conv2D(n_label, (1, 1), strides=(1,1), activation="elu", padding="same", name = 'conv1_1_D')(conv1_2_D_bn)
